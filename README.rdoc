...
This is Didn't, the testing framework. It was originally designed in ruby (note the rake task) but can be easily ported to any language.

== What is Didn't?

Didn't is a testing framework that aims to be lightweight and helps to cut down on new development time by as much as 30-60%. However, the cost for this gain is usually incurred in the support phase. Didn't has been influcenced by other testing methodologies such as Testing by Compilation and HDD (Hope-Driven Development).
